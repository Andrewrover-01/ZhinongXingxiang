...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-8 p-6 pb-safe">
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-sm sm:max-w-2xl sm:grid-cols-4">
        {[
